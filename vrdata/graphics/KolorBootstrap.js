...
function addKolorSocial(pPlugID) 
{
	...
	{
		var kolorSocialJS = new ktools.Script("KolorSocialJS", crossDomainTargetUrl+"vrdata/graphics/KolorSocial/KolorSocial.min.js", [], true);
    ...
    if(mapsApiLength > 0){
        ...
        if (mapsApiLength > 1 && mapApiOrder[1]) {
            ...
            if (mapsApiLength > 2 && mapApiOrder[2]) {
                ...
                var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript3], false);
                var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
                var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
                var mapstractionScriptCoreLayer3 = new ktools.Script("maps_mapstraction_core_layer3", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/"+mapApiOrder[2][3]+refreshIE, [mapstractionScriptCore], false);
                var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCoreLayer3], false);
                var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
            } else {
                if(mapsApiLength > 2){
                    var tmp_counter = mapLoadedCounter.item(pluginName) - 1;
                    mapLoadedCounter.update(pluginName, tmp_counter);
                }
                var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript2], false);
                var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
                var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
                var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCore], false);
                var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
            }
        } else {
            if(mapsApiLength > 1){
            ...
            var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript], false);
            var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
            var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
            var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCore], false);
        }

        var kolorMapScript = null;
        if (useGoogleLabelsClass) {
            var googleLabelsScript = new ktools.Script("maps_google_labels", crossDomainTargetUrl+"vrdata/graphics/KolorMap/lib/mxn.googlev3.core.labels.js", [mapstractionScriptCoreLayer1], false);
            kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"vrdata/graphics/KolorMap/js/KolorMap.min.js", [googleLabelsScript], true);
        } else {
            kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"vrdata/graphics/KolorMap/js/KolorMap.min.js", [mapstractionScriptCoreLayer1], true);
        }
        mapPlugin.addScript(kolorMapScript);

        var kolorMapCSS = new ktools.CssStyle("kolormapCSS", crossDomainTargetUrl+"vrdata/graphics/KolorMap/js/kolorMap.css");
...
function initKolorMapOnReady(pluginName, defaultMapLayer, mapAreaDiv) {
    ...
    kolorMap.setGraphicsUrl(crossDomainTargetUrl+"vrdata/graphics/"+pluginName.toLowerCase()+"/");
